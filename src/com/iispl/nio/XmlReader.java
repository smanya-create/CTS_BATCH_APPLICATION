...
TransactionStatus transacrionStatus=TransactionStatus.FAILED;
                            	   ...
                            	   String failureCode=(e instanceof InvalidTransactionException)?"TXN-401 :TRANSACTION_PROBLEM"
                            			   : "XML-402 :XML_STRUCTURE_PROBLEM";
...
throw new InvalidTransactionException("Amount cannot be null for "+ transactionId);
}

if (amount.compareTo( BigDecimal.ZERO) <= 0) {

throw new InvalidTransactionException("Amount must be greater than zero for " + transactionId);
}
...
throw new InvalidTransactionException( "Transaction date cannot be null for and Transaction date cannot be in the future for " + transactionId);
